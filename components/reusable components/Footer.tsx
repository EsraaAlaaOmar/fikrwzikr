  ...
  return (
    ...
    <Row>
      ...
      <Col md={4}>
       ...
       <ul >
        ...
        <li className="col-xs-6"><a href="http://fikrwzikr.com/Category?id=1">القرآن الكريم</a></li>
        <li className="col-xs-5" ><a href="http://fikrwzikr.com/Category?id=18">الأدعية والابتهالات الدينية</a></li>
        <li className="col-xs-6"><a href="http://fikrwzikr.com/Category?id=26">الرقائق الإيمانية</a></li>
        <li className="col-xs-5" ><a href="http://fikrwzikr.com/Category?id=33">الحديث الشريف</a></li>
        <li className="col-xs-6"><a href="http://fikrwzikr.com/Category?id=39">أفكار وأذكار</a></li>
        <li className="col-xs-5" ><a href="http://fikrwzikr.com/Category?id=44">اكتشف نفسك</a></li>
        <li className="col-xs-6"><a href="http://fikrwzikr.com/Category?id=49">كأنك تراه - ﷺ</a></li>
        <li className="col-xs-5" ><a href="http://fikrwzikr.com/Category?id=55">كأنك معه - ﷺ</a></li>
        <li className="col-xs-6"><a href="http://fikrwzikr.com/Category?id=60">إنشاد</a></li>
        <li className="col-xs-5" ><a href="http://fikrwzikr.com/Category?id=68">خواطر الأحباب</a></li> 
       </ul> 
       </Row>
      </Col>
      <Col md={4}>
   ...
   <Col sm={8} xs={6}>
       <div className="copyright">
        <p> جميع الحقوق محفوظة © 2025 لدى شركة إيجيبت لينكس </p>    
       </div>     
  </Col>        
       <Col sm={4} xs={6}>
