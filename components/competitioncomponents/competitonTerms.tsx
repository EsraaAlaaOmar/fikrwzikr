...
const CompetitonTerms = () => {
  ...
  return (
   <>{ showterms&& <div className='overlay overlay_full_page' ref={ref} >
          ...
          <ul>
            <li>1.	هذه المسابقة تحت اشراف وزارة التضامن الاجتماعي بترخيص رقم (101) لسنة 2024 وجهاز حماية المستهلك بإخطار رقم (252) لسنة .2024</li>
            <li>2.	مدة المسابقة:تبدأ من9 اغسطس وتنتهي في 9 ديسمبر 2024</li>
            ...
            <li>11. يفوز 1 متسابق كل شهر له أعلى تصويت وتقييم في خلال مدة المسابقة على أن يتم استلام الجائزة خلال 15يوم
            من انتهاءالمسابقة.</li>
